...
#define ORIGINAL_FILE_NAME "UE4Editor-Echoes_Of_Time.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME Echoes_Of_Time
#define DEPRECATED_FORGAME DEPRECATED
#define ECHOES_OF_TIME_API DLLEXPORT
